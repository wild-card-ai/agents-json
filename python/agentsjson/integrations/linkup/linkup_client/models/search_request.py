...
class SearchRequest(object):
    ...
    @property
    def depth(self):
        """Gets the depth of this SearchRequest.  # noqa: E501
        ...
        :return: The depth of this SearchRequest.  # noqa: E501
        :rtype: object
        """
        return self._depth
    ...
    def depth(self, depth):
        """Sets the depth of this SearchRequest.

        Defines the precision of the search. `standard` returns results quickly; `deep` takes longer but yields more complete results.  # noqa: E501

        :param depth: The depth of this SearchRequest.  # noqa: E501
        :type: object
        """
        if depth is None:
    ...
    def output_type(self):
        """Gets the output_type of this SearchRequest.  # noqa: E501
        ...
        :return: The output_type of this SearchRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def output_type(self, output_type):
        """Sets the output_type of this SearchRequest.

        The type of output you want to get. Use `structured` for a custom-formatted response defined by `structuredOutputSchema`.  # noqa: E501

        :param output_type: The output_type of this SearchRequest.  # noqa: E501
        :type: object
        """
    ...
    def structured_output_schema(self):
        """Gets the structured_output_schema of this SearchRequest.  # noqa: E501
        ...
        :return: The structured_output_schema of this SearchRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def structured_output_schema(self, structured_output_schema):
        """Sets the structured_output_schema of this SearchRequest.

        Required only when `outputType` is `structured`. Provide a JSON schema (as a string) representing the desired response format. The root must be of type `object`.  # noqa: E501

        :param structured_output_schema: The structured_output_schema of this SearchRequest.  # noqa: E501
        :type: object
        """
    ...
    def include_images(self):
        """Gets the include_images of this SearchRequest.  # noqa: E501

        Defines whether the API should include images in its results.  # noqa: E501

        :return: The include_images of this SearchRequest.  # noqa: E501
        :rtype: object
        """
    ...
    def include_images(self, include_images):
        """Sets the include_images of this SearchRequest.

        Defines whether the API should include images in its results.  # noqa: E501

        :param include_images: The include_images of this SearchRequest.  # noqa: E501
        :type: object
        """
