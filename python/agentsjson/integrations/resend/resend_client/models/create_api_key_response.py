...
class CreateApiKeyResponse(object):
    ...
    @property
    def token(self):
        """Gets the token of this CreateApiKeyResponse.  # noqa: E501

        The token of the API key.  # noqa: E501

        :return: The token of this CreateApiKeyResponse.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this CreateApiKeyResponse.

        The token of the API key.  # noqa: E501

        :param token: The token of this CreateApiKeyResponse.  # noqa: E501
        :type: str
        """
