...
class UserList(object):
    ...
    @property
    def data(self):
        """Gets the data of this UserList.  # noqa: E501


        :return: The data of this UserList.  # noqa: E501
        :rtype: list[UserResponseData]
        """
        return self._data
