...
class FormFieldPlacement(object):
    ...
    def __init__(self, form_field_id=None, form_set_id=None, form=None, position=None, required=None, required_operator=None, placement_operator=None):  # noqa: E501
        """FormFieldPlacement - a model defined in Swagger"""  # noqa: E501
    ...
    def form_field_id(self):
        """Gets the form_field_id of this FormFieldPlacement.  # noqa: E501

        The form field that is placed.  # noqa: E501

        :return: The form_field_id of this FormFieldPlacement.  # noqa: E501
        :rtype: str
        """
    ...
    def form_field_id(self, form_field_id):
        """Sets the form_field_id of this FormFieldPlacement.

        The form field that is placed.  # noqa: E501

        :param form_field_id: The form_field_id of this FormFieldPlacement.  # noqa: E501
        :type: str
        """
    ...
    def form_set_id(self):
        """Gets the form_set_id of this FormFieldPlacement.  # noqa: E501

        The form set this field is placed in.  # noqa: E501

        :return: The form_set_id of this FormFieldPlacement.  # noqa: E501
        :rtype: str
        """
    ...
    def form_set_id(self, form_set_id):
        """Sets the form_set_id of this FormFieldPlacement.

        The form set this field is placed in.  # noqa: E501

        :param form_set_id: The form_set_id of this FormFieldPlacement.  # noqa: E501
        :type: str
        """
    ...
    @property
    def form(self):
        """Gets the form of this FormFieldPlacement.  # noqa: E501

        The form this field is placed on.  # noqa: E501

        :return: The form of this FormFieldPlacement.  # noqa: E501
        :rtype: str
        """
        return self._form
    ...
    @form.setter
    def form(self, form):
        """Sets the form of this FormFieldPlacement.

        The form this field is placed on.  # noqa: E501

        :param form: The form of this FormFieldPlacement.  # noqa: E501
        :type: str
        """
        if form is None:
    ...
    @property
    def position(self):
        """Gets the position of this FormFieldPlacement.  # noqa: E501

        The position of the field placement.  # noqa: E501

        :return: The position of this FormFieldPlacement.  # noqa: E501
        :rtype: int
        """
    ...
    def position(self, position):
        """Sets the position of this FormFieldPlacement.

        The position of the field placement.  # noqa: E501

        :param position: The position of this FormFieldPlacement.  # noqa: E501
        :type: int
        """
        if position is None:
    ...
    @property
    def required(self):
        """Gets the required of this FormFieldPlacement.  # noqa: E501

        Whether the field is unconditionally required on this form.  # noqa: E501

        :return: The required of this FormFieldPlacement.  # noqa: E501
        :rtype: bool
        """
    ...
    def required(self, required):
        """Sets the required of this FormFieldPlacement.

        Whether the field is unconditionally required on this form.  # noqa: E501

        :param required: The required of this FormFieldPlacement.  # noqa: E501
        :type: bool
        """
        if required is None:
    ...
    def required_operator(self):
        """Gets the required_operator of this FormFieldPlacement.  # noqa: E501

        Logical operator when evaluating multiple form_field_placement_conditions with conditioned=required  # noqa: E501

        :return: The required_operator of this FormFieldPlacement.  # noqa: E501
        :rtype: str
        """
    ...
    def required_operator(self, required_operator):
        """Sets the required_operator of this FormFieldPlacement.

        Logical operator when evaluating multiple form_field_placement_conditions with conditioned=required  # noqa: E501

        :param required_operator: The required_operator of this FormFieldPlacement.  # noqa: E501
        :type: str
        """
    ...
    def placement_operator(self):
        """Gets the placement_operator of this FormFieldPlacement.  # noqa: E501

        Logical operator when evaluating multiple form_field_placement_conditions with conditioned=placement  # noqa: E501

        :return: The placement_operator of this FormFieldPlacement.  # noqa: E501
        :rtype: str
        """
    ...
    def placement_operator(self, placement_operator):
        """Sets the placement_operator of this FormFieldPlacement.

        Logical operator when evaluating multiple form_field_placement_conditions with conditioned=placement  # noqa: E501

        :param placement_operator: The placement_operator of this FormFieldPlacement.  # noqa: E501
        :type: str
        """
        allowed_values = ["and", "or"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FormFieldPlacement, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FormFieldPlacement):
            return False
