...
class EnvironmentsApi(object):
    ...
    def create_environment(self, body, **kwargs):  # noqa: E501
        """Creates a environment  # noqa: E501

        Creates a new environment from provided data  # noqa: E501
        ...
        :param NewEnvironment body: (required)
    ...
    def delete_environment(self, id, **kwargs):  # noqa: E501
        ...
        Delete a specific environment by id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_environment(self, id, **kwargs):  # noqa: E501
        """Retrieves a environment  # noqa: E501

        Retrieves a specific environment by id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_environment_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def list_environments_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['include', 'page_number', 'page_size', 'filter_search', 'filter_slug', 'filter_name', 'filter_color', 'filter_created_at_gt', 'filter_created_at_gte', 'filter_created_at_lt', 'filter_created_at_lte', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_environment(self, body, id, **kwargs):  # noqa: E501
        """Update a environment  # noqa: E501

        Update a specific environment by id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_environment(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UpdateEnvironment body: (required)
        :param str id: (required)
        :return: EnvironmentResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_environment_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_environment_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_environment_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update a environment  # noqa: E501

        Update a specific environment by id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_environment_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
