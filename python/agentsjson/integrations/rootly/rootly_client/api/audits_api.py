...
class AuditsApi(object):
    ...
    def list_audits(self, **kwargs):  # noqa: E501
        ...
        :param str filter_user_id:
        :param str filter_api_key_id:
        :param str filter_source:
        :param str filter_item_type:
        :param str sort:
        :return: AuditsList
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_audits_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_audits_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['include', 'page_number', 'page_size', 'filter_created_at_gt', 'filter_created_at_gte', 'filter_created_at_lt', 'filter_created_at_lte', 'filter_user_id', 'filter_api_key_id', 'filter_source', 'filter_item_type', 'sort']  # noqa: E501
        ...
        if 'filter_api_key_id' in params:
            query_params.append(('filter[api_key_id]', params['filter_api_key_id']))  # noqa: E501
        if 'filter_source' in params:
            query_params.append(('filter[source]', params['filter_source']))  # noqa: E501
        if 'filter_item_type' in params:
            query_params.append(('filter[item_type]', params['filter_item_type']))  # noqa: E501
        if 'sort' in params:
