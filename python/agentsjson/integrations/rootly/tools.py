...
import re
from .rootly_client.api_client import ApiClient
from .rootly_client.configuration import Configuration
from .rootly_client.rest import ApiException
import json
...
class RestApiHandler:
    ...
    def execute(
        ...
        """
        Execute a generic REST API call against the Rootly API using the provided AuthConfig.
        ...
        :param headers: Optional headers to include. Defaults to application/vnd.api+json.
        ...
        if auth_config.type == AuthType.BEARER:
            ...
            raise ValueError(f"Unsupported auth type '{auth_config.type}' for Rootly API calls in the generic handler.")
        ...
        configuration.host = "https://api.rootly.com"
