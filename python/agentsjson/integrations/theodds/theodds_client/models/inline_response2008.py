...
class InlineResponse2008(object):
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this InlineResponse2008.  # noqa: E501
        ...
        :return: The timestamp of this InlineResponse2008.  # noqa: E501
        :rtype: str
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this InlineResponse2008.

        The timestamp of the snapshot. This will be the closest available timestamp equal to or earlier than the provided date parameter.  # noqa: E501

        :param timestamp: The timestamp of this InlineResponse2008.  # noqa: E501
        :type: str
        """
    ...
    def previous_timestamp(self):
        """Gets the previous_timestamp of this InlineResponse2008.  # noqa: E501

        The preceding available timestamp. This can be used as the date parameter in a new request to move back in time.  # noqa: E501

        :return: The previous_timestamp of this InlineResponse2008.  # noqa: E501
        :rtype: str
        """
    ...
    def previous_timestamp(self, previous_timestamp):
        """Sets the previous_timestamp of this InlineResponse2008.

        The preceding available timestamp. This can be used as the date parameter in a new request to move back in time.  # noqa: E501

        :param previous_timestamp: The previous_timestamp of this InlineResponse2008.  # noqa: E501
        :type: str
        """
    ...
    def next_timestamp(self):
        """Gets the next_timestamp of this InlineResponse2008.  # noqa: E501

        The next available timestamp. This can be used as the date parameter in a new request to move forward in time.  # noqa: E501

        :return: The next_timestamp of this InlineResponse2008.  # noqa: E501
        :rtype: str
        """
    ...
    def next_timestamp(self, next_timestamp):
        """Sets the next_timestamp of this InlineResponse2008.

        The next available timestamp. This can be used as the date parameter in a new request to move forward in time.  # noqa: E501

        :param next_timestamp: The next_timestamp of this InlineResponse2008.  # noqa: E501
        :type: str
        """
