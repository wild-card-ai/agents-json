...
class SegmentsApi(object):
    ...
    def list_segments(self, **kwargs):  # noqa: E501
        """List all segments  # noqa: E501

        You can fetch a list of all segments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_segments(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param IntercomVersion intercom_version:
        :param bool include_count: It includes the count of contacts that belong to each segment.
        :return: SegmentList
        ...
        if kwargs.get('async_req'):
            return self.list_segments_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_segments_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_segments_with_http_info(self, **kwargs):  # noqa: E501
        """List all segments  # noqa: E501

        You can fetch a list of all segments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_segments_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['intercom_version', 'include_count']  # noqa: E501
        ...
        if 'include_count' in params:
            query_params.append(('include_count', params['include_count']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SegmentList',  # noqa: E501
    ...
    def retrieve_segment(self, segment_id, **kwargs):  # noqa: E501
        """Retrieve a segment  # noqa: E501

        You can fetch the details of a single segment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_segment(segment_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str segment_id: The unique identified of a given segment. (required)
        :param IntercomVersion intercom_version:
        :return: Segment
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.retrieve_segment_with_http_info(segment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.retrieve_segment_with_http_info(segment_id, **kwargs)  # noqa: E501
            return data

    def retrieve_segment_with_http_info(self, segment_id, **kwargs):  # noqa: E501
        """Retrieve a segment  # noqa: E501

        You can fetch the details of a single segment.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_segment_with_http_info(segment_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['segment_id', 'intercom_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method retrieve_segment" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('segment_id' not in params or
            ...
            raise ValueError("Missing the required parameter `segment_id` when calling `retrieve_segment`")  # noqa: E501
